    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="clube.php" class="nav-item nav-link active">Clube do Livro</a>
    ...
    <div class="container-xxl py-5 category">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Gerenciar Clube do Livro</h1>
            </div>
            <div class="row g-4">
...
if (isset($_GET['search'])) {
    ...
    $sql = "SELECT * FROM clube WHERE nome LIKE '%$search%' OR titulo LIKE '%$search%' ORDER BY nome";
} else {
    // Consulta para selecionar todos os livros do acervo
    $sql = "SELECT * FROM clube ORDER BY titulo";
}
...
<div class="container">
    <h2 style="margin-bottom: 20px;">Lista de ' . $result->num_rows . ' Livros do Clube do Livro</h2>

    <!-- Barra de pesquisa com ícone de lupa -->
    <form method="GET" action="clube.php">
    ...
    <ul>';
        if ($result->num_rows > 0) {
            while ($livro = $result->fetch_assoc()) {
                $clubeId = $livro["id"]; // Corrigido de $row para $livro
                $titulo = $livro['titulo'];
                $nome = $livro['nome'];
                $turma = $livro['turma'];
                $pagina = $livro['pagina'];
                ...
                echo '<a href="atualizarClube.php?id=' . $clubeId . '"><i class="fas fa-edit"></i></a>';
                echo '<a href="devolucaoClube.php?id=' . $clubeId . '" onclick="return confirm(\'Tem certeza de que deseja confirmar a devolução do livro?\')" style="margin-left: 10px;"><i class="fas fa-check-circle"></i></a>';
                echo '<a href="deletarClube.php?id=' . $clubeId . '" onclick="return confirm(\'Tem certeza de que deseja deletar o empréstimo?\')" style="margin-left: 10px;"><i class="fas fa-trash"></i></a>';
                echo '</li>';
            }
        } else {
...
<div style="display: flex; justify-content: center; padding-bottom: 20px; padding-top: 15;">
    <form style="background-color: #f7f7f7; box-shadow: 0px 0px 15px #666; width: 55%; border-radius: 15px;" method="post" action="adicionarClube.php" id="formlogin" name="formlogin">
        <div style="padding: 50px; display: flex; flex-wrap: wrap;">
            <div style="padding-bottom: 25px; width: 100%; display: block;">
                <h2 style="display: flex; justify-content: center; color: rgba(17, 27, 88, 0.7);">Adicionar Novo Clube do Livro</h2>
            </div>
