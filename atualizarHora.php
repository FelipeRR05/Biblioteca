    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="atualizarHora.php" class="nav-item nav-link active">Atualizar Hora da Leitura</a>
    ...
    <div class="container-xxl py-5 category">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Atualizar Hora da Leitura</h1>
            </div>
            <div class="row g-4">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE hora SET titulo='$titulo', nome='$nome', turma='$turma', pagina='$pagina' WHERE id='$horaId'";

    if ($conn->query($sql) === TRUE) {
        // Redirecionar o usuário de volta à página de gerenciamento de livros
        echo "<script>window.location.href = 'hora.php';</script>";
...
if (isset($_GET['id'])) {
    $horaId = $_GET['id'];
    $sql = "SELECT * FROM hora WHERE id = '$horaId'";
...
<div style="display: flex; justify-content: center; padding-bottom: 20px; padding-top: 15;">
    <form style="background-color: #f7f7f7; box-shadow: 0px 0px 15px #666; width: 55%; border-radius: 15px;" method="post" action="atualizarHora.php" id="formlogin" name="formlogin">
        <div style="padding: 50px; display: flex; flex-wrap: wrap;">
            <div style="padding-bottom: 25px; width: 100%; display: block;">
                <h2 style="display: flex; justify-content: center; color: rgba(17, 27, 88, 0.7);">Atualizar Hora da Leitura</h2>
            </div>
            <input type="hidden" name="horaId" value="<?php echo $horaId; ?>">
