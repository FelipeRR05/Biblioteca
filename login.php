...
?>
      ...
      <link rel="stylesheet" type="text/css" href="style.css">
        ...
        <form style="background-color: #f7f7f7; box-shadow: 0px 0px 15px #666; width: 55%; border-radius: 15px;" method="post" action="verificaLogin.php" id="formlogin" name="formlogin">
        <div style="padding: 50px; display: block;">   
        <h2 style="color: rgba(17, 27, 88, 0.7);">Login</h2>
            ...
            <input style="display: block; border: 2px solid #ccc; width: 95%; height: 55px; padding: 10px; margin: 10px; border-radius: 5px;" placeholder="Email" type="email" id="email" name="email" required>
        </div>

            <label style="float: left; position: relative; padding-bottom: 12px; padding-top: 0px; ">Esqueceu seu Email? <a href="esqueceuEmail.php"> RECUPERE AQUI </a></label>    
    ...
    <div style="position: relative;">
        ...
        <span style="padding-right: 10px; position: absolute; right: 10px; top: 50%; transform: translateY(-50%); cursor: pointer;" onclick="togglePasswordVisibility('senha', 'icone-senha')">
            ...
            <label style="float: left; position: relative; padding-bottom: 12px; padding-top: 0px; ">Esqueceu sua Senha? <a href="esqueceuSenha.php"> RECUPERE AQUI </a></label>    

            <div style="padding-bottom: 12px; padding-top: 41px;">
            <div style="width: 100%; display: flex; justify-content: space-between; align-items: center;">
                <label style="position: relative; top: 10px; ">Novo na Magic Book Library? <a href="cadastro.php"> CADASTRE-SE </a></label>
