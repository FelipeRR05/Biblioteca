    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="atualizarClube.php" class="nav-item nav-link active">Atualizar Clube do Livro</a>
    ...
    <div class="container-xxl py-5 category">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Clube do Livro</h6>
                <h1 class="mb-5">Atualizar Clube do Livro</h1>
            </div>
            <div class="row g-4">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE clube SET titulo='$titulo', nome='$nome', turma='$turma', pagina='$pagina' WHERE id='$clubeId'";

    if ($conn->query($sql) === TRUE) {
        // Redirecionar o usuário de volta à página de gerenciamento de livros
        echo "<script>window.location.href = 'clube.php';</script>";
...
if (isset($_GET['id'])) {
    $clubeId = $_GET['id'];
    $sql = "SELECT * FROM clube WHERE id = '$clubeId'";
...
<div style="display: flex; justify-content: center; padding-bottom: 20px; padding-top: 15;">
    <form style="background-color: #f7f7f7; box-shadow: 0px 0px 15px #666; width: 55%; border-radius: 15px;" method="post" action="atualizarClube.php" id="formlogin" name="formlogin">
        <div style="padding: 50px; display: flex; flex-wrap: wrap;">
            <div style="padding-bottom: 25px; width: 100%; display: block;">
                <h2 style="display: flex; justify-content: center; color: rgba(17, 27, 88, 0.7);">Atualizar Clube do Livro</h2>
            </div>
            <input type="hidden" name="clubeId" value="<?php echo $clubeId; ?>">
            ...
            <div style="width: 100%; padding-bottom: 12px; display: flex;">
                <div style="flex: 1;">
                <label style="float: left; padding-bottom: 5px; width: 100px;" for="turma">Turma</label><br>
                <input style="flex: 1; width: calc(100% - 0px); border: 2px solid #ccc; height: 55px; padding: 10px; margin: 10px; border-radius: 5px;" type="number" id="turma" name="turma" value="<?php echo $turma; ?>">
            </div>
                <div style="flex: 1; margin-left: 20px;">
                    <label style="float: left; padding-bottom: 5px; width: 100px;" for="pagina">Páginas Lidas</label><br>
                    <input style="width: 100%; border: 2px solid #ccc; height: 55px; padding: 10px; margin: 10px; border-radius: 5px;" type="number" id="pagina" name="pagina" value="<?php echo $pagina; ?>">
                </div>
            </div>
