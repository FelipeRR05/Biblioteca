    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="atualizarUsuario.php" class="nav-item nav-link active">Atualizar Usuário</a>
    ...
    <div class="container-xxl py-5 category">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Atualizar Usuário</h1>
            </div>
            <div class="row g-4">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE usuario SET nome='$nome', email='$email', telefone='$telefone', endereco='$endereco', cpf='$cpf', senha='$senha', turma='$turma', idade='$idade' , matricula='$matricula' , serie='$serie' WHERE id='$id'";
    ...
    <div class="container" style="padding: 50px; background-color: #f7f7f7; box-shadow: 0px 0px 15px #666; width: 55%; border-radius: 15px;">
        <form action="atualizarUsuario.php" method="POST">
            <div style="display: flex; justify-content: center;">
                <h2 style="color: rgba(17, 27, 88, 0.7);">Atualizar Usuário</h2>
            </div>
            ...
            <div style="padding-bottom: 12px;">
                ...
                <div style="width: 48%; padding-bottom: 12px;">
                    ...
                    <input style="display: block; border: 2px solid #ccc; width: 100%; height: 55px; padding: 10px; margin: 10px; border-radius: 5px;" placeholder="Nome" type="text" id="nome" name="nome" value="<?php echo $nome; ?>">
                </div>
                <div style="width: 48%; padding-bottom: 12px;">
                    <label style="float: left; padding-bottom: 5px; " for="cpf">CPF</label><br>
                    <input style="display: block; border: 2px solid #ccc; width: 100%; height: 55px; padding: 10px; margin: 10px; border-radius: 5px;" placeholder="CPF" onkeyup="formatarCPF()" type="text" id="cpf" name="cpf" value="<?php echo $cpf; ?>">
                </div>
                </div>
                <div style="width: 100%; padding-bottom: 12px;">
                    <label style="float: left; padding-bottom: 5px;" for="email">Email</label><br>
                    <input style="display: block; border: 2px solid #ccc; width: 100%; height: 55px; padding: 10px; margin: 10px; border-radius: 5px;" placeholder="Email" type="email" id="email" name="email" value="<?php echo $email; ?>">
                </div>
                <div style="display: flex; justify-content: space-between; width: 100%;">
            <div style="width: 48%; padding-bottom: 12px;">
            ...
            <div style="width: 48%; padding-bottom: 12px;">
                ...
                <select style="display: block; border: 2px solid #ccc; width: 100%; height: 55px; padding: 10px; margin: 10px; border-radius: 5px;" id="turma" name="turma" value="<?php echo $turma; ?>">
                <?php
    ...
    ?>
            ...
            <div style="display: flex; justify-content: space-between; width: 100%;">
                <div style="width: 48%; padding-bottom: 12px;">
                    ...
                    <input style="display: block; border: 2px solid #ccc; width: 100%; height: 55px; padding: 10px; margin: 10px; border-radius: 5px;" placeholder="Matrícula" type="number" id="matricula" name="matricula" value="<?php echo $matricula; ?>">
                </div>
                <div style="width: 48%; padding-bottom: 12px;">
                    <label style="float: left; padding-bottom: 5px; " for="idade">Idade</label><br>
                    <input style="display: block; border: 2px solid #ccc; width: 100%; height: 55px; padding: 10px; margin: 10px; border-radius: 5px;" placeholder="Idade" type="number" id="idade" name="idade" value="<?php echo $idade; ?>">
                </div>
            </div>
                <div style="display: flex; justify-content: space-between; width: 100%;">
                <div style="width: 48%; padding-bottom: 12px;">
                    <label style="float: left; padding-bottom: 5px; " for="telefone">Telefone</label><br>
                    <input style="display: block; border: 2px solid #ccc; width: 100%; height: 55px; padding: 10px; margin: 10px; border-radius: 5px;" placeholder="Telefone" onkeyup="formatarTelefone()" type="tel" id="telefone" name="telefone" value="<?php echo $telefone; ?>">
                </div>
                <div style="width: 48%; padding-bottom: 12px;">
                    <label style="float: left; padding-bottom: 5px; " for="endereco">Endereço</label><br>
                    <input style="display: block; border: 2px solid #ccc; width: 100%; height: 55px; padding: 10px; margin: 10px; border-radius: 5px;" placeholder="Endereço" type="text" id="endereco" name="endereco" value="<?php echo $endereco; ?>">
                </div>
                </div>
                <div style="width: 100%; padding-bottom: 12px;">
        <label style="float: left; padding-bottom: 5px;" for="senha">Senha</label><br>
        <div style="position: relative;">
            <input style="display: block; border: 2px solid #ccc; width: 100%; height: 55px; padding: 10px; margin: 10px; border-radius: 5px;" placeholder="Senha" type="text" id="senha" name="senha" value="<?php echo $senha; ?>">
