    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="editarClube.php" class="nav-item nav-link active">Editar</a>
    ...
    <div class="container-xxl py-5 category">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Editar Clube do Livro</h1>
            </div>
            <div class="row g-4">
...
<div style="display: flex; justify-content: center; padding-bottom: 20px; padding-top: 15;">
    <form style="background-color: #f7f7f7; box-shadow: 0px 0px 15px #666; width: 55%; border-radius: 15px;" method="post" action="editarClube.php" id="formlogin" name="formlogin">
        <div style="padding: 50px; display: flex; flex-wrap: wrap;">
            <div style="padding-bottom: 25px; width: 100%; display: block;">
                <h2 style="display: flex; justify-content: center; color: rgba(17, 27, 88, 0.7);">Editar Clube do Livro</h2>
            </div>
            ...
            <div style="width: 100%; padding-bottom: 12px; display: flex;">
                ...
                <input style="flex: 1; width: calc(100% - 0px); border: 2px solid #333; height: 55px; background-color: #eee; color: #333; height: 55px; padding: 10px; margin: 10px; border-radius: 5px;" type="number" id="turma" name="turma" value="<?php echo $turma; ?>" readonly>
            </div>
