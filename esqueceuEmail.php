    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="esqueceuEmail.php" class="nav-item nav-link active">Recuperar Email</a>
...
?>
      ...
      <link rel="stylesheet" type="text/css" href="style.css">
        ...
        <form style="background-color: #f7f7f7; box-shadow: 0px 0px 15px #666; width: 55%; border-radius: 15px;" method="post" action="verificarEmail.php" id="formlogin" name="formlogin">
        <div style="padding: 50px; display: block;">   
        <h2 style="color: rgba(17, 27, 88, 0.7);">Recuperar Email</h2>
