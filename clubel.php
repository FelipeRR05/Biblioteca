    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="clubel.php" class="nav-item nav-link active">Empréstimo</a>
    ...
    if ($result->num_rows > 0) {
        ...
        if ($result->num_rows > 0) {
            ...
            <div class="container" style="padding: 50px; background-color: #f7f7f7; box-shadow: 0px 0px 15px #666; width: 55%; border-radius: 15px;">
                <form action="registroClube.php" method="POST">
                    ...
                    <div style="width: 100%; padding-bottom: 12px;">
                        ...
                        <input style="display: block; border: 2px solid #333; background-color: #eee; color: #333; width: 100%; height: 55px; padding: 10px; margin: 10px; border-radius: 5px;" type="number" id="turma" name="turma" value="' . $turma . '" readonly>
                    </div>
